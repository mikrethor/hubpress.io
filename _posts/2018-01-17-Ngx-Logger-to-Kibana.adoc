...
My last link:2018-01-15-Log-in-angular-with-Ngx-Logger.html[post] was about NgxLogger and its logging capabilities.
One of the reason I chose NgxLogger was that I liked the possibility to send my logs through a url in a Json format. This post is about my experiment with Ngxlogger, Elasticsearch and Kibana.
...
image::http://github.com/mikrethor/blog/images/2018-01-17-Ngxlogger-Kibana[Kibana NgxLogger]